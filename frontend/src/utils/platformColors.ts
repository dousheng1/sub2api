...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'grok' | 'composite' | 'serper'
...
const BADGE: Record<Platform, string> = {
  ...
  serper: 'bg-cyan-500/10 text-cyan-600 border-cyan-500/30 dark:text-cyan-400',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  serper: 'bg-cyan-500/10 text-cyan-600 dark:bg-cyan-500/10 dark:text-cyan-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  serper: 'border-cyan-500/20 dark:border-cyan-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  serper: 'bg-gradient-to-r from-cyan-400 to-cyan-500',
}
...
const TEXT: Record<Platform, string> = {
  ...
  serper: 'text-cyan-600 dark:text-cyan-400',
}
...
const ICON: Record<Platform, string> = {
  ...
  serper: 'text-cyan-500 dark:text-cyan-400',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  serper: 'bg-cyan-600 text-white hover:bg-cyan-700 active:bg-cyan-800 dark:bg-cyan-600/80 dark:hover:bg-cyan-600',
}
...
const DISCOUNT: Record<Platform, string> = {
  ...
  serper: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  serper: 'from-cyan-500 to-cyan-600',
}
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'grok' || p === 'composite' || p === 'serper'
}
